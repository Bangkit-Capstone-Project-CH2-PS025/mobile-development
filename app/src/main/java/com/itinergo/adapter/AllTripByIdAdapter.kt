...
class AllTripByIdAdapter(private var itemClick: ListPlaceInterface) :
    RecyclerView.Adapter<AllTripByIdAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: FindTripListItemBinding) :
        ...
        fun bind(item: Data?) {
            ...
            binding.btnTrip.text = "Close Trip"
            ...
            binding.btnTrip.setOnClickListener {
                itemClick.yourTrip(item?.id.toString())
            }
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    override fun onBindViewHolder(holder: AllTripByIdAdapter.ViewHolder, position: Int) {
